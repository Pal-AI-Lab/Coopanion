/** Bundles the promo into one self-contained page: promo/dist/index.html (+ assets/). */
...
const js = (await esbuild.build({ entryPoints: [`${HERE}src/main.js`], bundle: true, format: 'iife', write: false, minify: true, target: 'es2022' })).outputFiles[0].text.replace(/<\/script/gi, '<\/script');
