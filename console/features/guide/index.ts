...
const S = pick({
  zh: {
    ...
    modelLead: '填一个 DeepSeek 的 API Key。按用量计费,充几块钱能用很久。',
    howTitle: '还没有 Key?',
  ...
  en: {
    ...
    modelLead: 'Enter a DeepSeek API key. It is billed by use; a small top-up lasts a long time.',
    howTitle: 'No key yet?',
    how1: 'Open the DeepSeek platform and sign up',
    how1Link: 'Open',
    how2: 'Top up a little',
